...
<body>
    ...
    <div id="termsText">
        ...
        <p>TotalyScience.co LLC does not guarantee the accuracy of any information included in any of our family of
        ...
        <p>We are not responsible for any of the content included in any of our licensed content that is authored by
            people not employed by Totallyscience.co LLC, such as our games at Totallyscience.co.</p>
        <p>TotallyScience is not responsible for any ads that may appear on our sites via error or malware viruses.</p>
        <p>Materials on this site, as well as the organization and layout of the site may not be copied, modified,
            ...
            whole or in part.</p>
        <p>YOUR USE OF THE TOTALLYSCIENCE FAMILY OF SITES IS ON AN "AS IS," "AS AVAILABLE" BASIS, AND WE SPECIFICALLY
            ...
            WHETHER TORT (INCLUDING NEGLIGENCE), CONTRACT OR OTHERWISE, SHALL TOTALLYSCIENCE, ITS AFFILIATES, AND ITS
            ...
            THE “TOTALLYSCIENCE PARTIES”) BE LIABLE (JOINTLY OR SEVERALLY) TO YOU OR ANY OTHER PERSON AS A RESULT OF
            YOUR USE OF THE TotallyScience FAMILY OF SITES FOR INDIRECT, CONSEQUENTIAL, SPECIAL, INCIDENTAL, EXEMPLARY
            ...
            LIABILITY FOR ANY LOSS OR DAMAGE RELATING TO THE TOTALLYSCIENCE FAMILY OF SITES SHALL NOT EXCEED AN AMOUNT
            ...
            apply to you.</p>
        <p>You agree to use the TotallyScience family of sites in compliance with all applicable laws, regulations and
            rulings. We reserve the right to terminate or restrict your access to the TOTALLYSCIENCE sites in our sole
        ...
        <p>To the fullest extent of the law, you agree to indemnify and hold the TotallyScience Parties harmless from
            ...
            use of the TotallyScience family of sites.</p>
        <p>Irrespective of the residence of any user, these Terms of Use shall be governed by New York law excluding its
            ...
            USE.</p>
        <p>We administer the TotallyScience family of sites from the United States of America. If you choose to access
            the TotallyScience sites from outside the United States, you consent to the transfer of information outside
        ...
        <p>Note: This document is subject to change at any time. When it does, the changes will be posted on this page.
            Your continued use of the TotallyScience family of sites indicates that you accept the terms spelled out in
            this document.</p>
